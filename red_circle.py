...
def main():
    ...
    while(True):
        ...
        captured_frame = cv2.imread("images/red3.png")
        output_frame = captured_frame.copy()
        ...
        lower_mask = cv2.inRange(captured_frame_lab, lower1, upper1)
        upper_mask = cv2.inRange(captured_frame_lab, lower2, upper2)

        full_mask = lower_mask + upper_mask;
        #captured_frame_lab_red= cv2.bitwise_and(output_frame, output_frame, mask=full_mask)
